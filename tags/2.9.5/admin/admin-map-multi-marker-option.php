		...
		<div class="panel panel-default">
	    	<div class="panel-heading" role="tab" id="headingOne">
				<h4 class="panel-title">
					<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="action-accordeon collapsed">
						<i class="fa fa-cogs" aria-hidden="true"></i> <?php _e('Map option', 'map-multi-marker'); ?> <i class="fa fa-caret-down" aria-hidden="true"></i>
	        		</a>
	      		</h4>
		  	</div>
							    ...
							    <table class="form-table">
							    	...
							    	<tr>
							    		<th scope="row">
											...
											<span class="help_tooltip" id="help_map_height"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
							    		</th>
							    		<td>
							        ...
							        <tr>
							            <th scope="row">
											...
											<span class="help_tooltip" id="help_map_zoom"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
										</th>
							            <td>
							        ...
							        <tr>
							            <th scope="row">
							                <label for="latitude_initial"><?php _e('Initial latitude', 'map-multi-marker'); ?></label>
											<span class="help_tooltip" id="help_map_latitude_initial"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
										</th>
							            <td>
							        ...
							        <tr>
							            <th scope="row">
							                <label for="longitude_initial"><?php _e('Initial longitude', 'map-multi-marker'); ?></label>
											<span class="help_tooltip" id="help_map_longitude_initial"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
										</th>
							            <td>
							        ...
							        <tr>
							            <th scope="row">
											...
											<span class="help_tooltip" id="help_map_maptype"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
							            </th>
							            <td>
							...
							<div class="col-md-6">
							    <table class="form-table">
							        <tr>
							            ...
							            <td>
							            	<input id="lightbox" type="checkbox" name="lightbox" <?php if($data[0]['lightbox'] == 1){echo 'checked';} ?>>
							            </td>
							        </tr>
									<tr>
										<th scope="row">
											<label for="scrollwheel"><?php _e('Scrollwheel zoom', 'map-multi-marker'); ?></label>
											<span class="help_tooltip" id="help_map_scroolwheel"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
										</th>
										<td>
											<input id="scrollwheel" type="checkbox" name="scrollwheel" <?php if($data[0]['scrollwheel'] == 1){echo 'checked';} ?>>
										</td>
									</tr>
							        <tr>
							            <th scope="row">
							                <label for="streetview"><?php _e('Streetview', 'map-multi-marker'); ?></label>
											<span class="help_tooltip" id="help_map_streetview"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
							            </th>
							            <td>
							            	<input id="streetview" type="checkbox" name="streetview" <?php if($data[0]['streetview'] == 0){echo 'checked';} ?>>
							            </td>
							        </tr>
							        <tr>
							            <th scope="row">
							                <label for="fiels_to_display"><?php _e('Fields to display in tooltip', 'map-multi-marker'); ?></label>
							        ...
							        <tr>
							            <th scope="row">
							                <label for="default_desc_img"><?php _e('Default image tooltip when a new marker is created', 'map-multi-marker'); ?></label>
							            ...
							            <td>
								            <div class="wrap-set-default-img">
									            <img class="default_img_preview thumb-img-admin" src="<?php if($data[0]['default_desc_img_url']==0){echo MMM_URL.$mapmarker_info['default_desc_img_url'];}else{echo wp_get_attachment_url($data[0]['default_desc_img_url']);}?>" alt="">
												<input type='hidden' name='default_desc_img_id' class='default_img_id' value='<?php echo  esc_html($data[0]['default_desc_img_url']) ?>'>
									            <input id="upload_desc_img_button" type="button" class="button" value="<?php _e( 'Change image' ); ?>" />
								            </div>
							            </td>
							        </tr>
									<tr>
							            <th scope="row">
							                <label for="default_marker_img"><?php _e('Default marker icon when a new marker is created', 'map-multi-marker'); ?></label>
											<span class="help_tooltip" id="help_map_default_marker_img"><i class="fa fa-question-circle" aria-hidden="true"></i></span>
										</th>
							            <td>
								            <div class="wrap-set-default-img">
									            <img class="default_img_preview thumb-img-admin" src="<?php if($data[0]['default_marker_img_url']==0){echo MMM_URL.$mapmarker_info['default_marker_img_url'];}else{echo wp_get_attachment_url($data[0]['default_marker_img_url']);}?>" alt="">
												<input type='hidden' name='default_marker_img_id' class='default_img_id' value='<?php echo  esc_html($data[0]['default_marker_img_url']) ?>'>
									            <input id="upload_marker_img_button" type="button" class="button" value="<?php _e( 'Change image' ); ?>" />
								            </div>
							            </td>
							        </tr>
							   </table>
