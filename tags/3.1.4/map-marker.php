...
class MapMultiMarker
{
    ...
    public function mmm_front_register_script()
    {
        ...
        wp_register_style('mmm-front-css', $this->plugin_url . 'asset/css/front.css');
        wp_register_style('fontawesome-css', $this->plugin_url . 'asset/css/font-awesome.min.css');
        wp_register_style('featherlight-css', $this->plugin_url . 'asset/css/featherlight.min.css');
        wp_register_script('mmm-googlemap-js', 'https://maps.googleapis.com/maps/api/js?key=' . $settings['api_key'] . '&language=' . $settings['language'], false, null, true);
        wp_register_script('mmm-front-js', $this->plugin_url . 'asset/js/front.js', null, null, true);
        wp_register_script('featherlight-js', $this->plugin_url . 'asset/js/featherlight.min.js', ['jquery'], null, true);
