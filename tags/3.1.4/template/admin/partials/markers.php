...
if (isset($_POST['securite_nonce_upload_csv'])) {
    if (wp_verify_nonce($_POST['securite_nonce_upload_csv'], 'securite_nonce_upload_csv')) {
        ...
        try {
            ...
            csv_reader::insertCsv($_FILES['csv_file'], $_GET['map_id'], $options[0]);
    ...
    <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title">
            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" class="action-accordeon">
                <i class="fa fa-map-marker" aria-hidden="true"></i> <?php _e('Management marker', MapMultiMarker::TEXT_DOMAIN) ?>
        ...
        <div class="panel-body">
            <form method="POST" action="" enctype="multipart/form-data" id="form-upload-csv">
                ...
                <button id="upload_csv_submit" type="submit" class="button-primary button-orange">
                    <i class="fa fa-plus" aria-hidden="true"></i> <?php _e('Import .csv', MapMultiMarker::TEXT_DOMAIN) ?>
                </button>
            </form>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <table class="widefat" id="table_markers">
                    ...
                    <tr>
                        ...
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'image') == true) {
                            ?>
                            <th style="text-align: center">
                        ...
                        ?>
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'titre') == true) {
                            ?>
                        ...
                        ?>
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'description') == true) {
                            ?>
                        ...
                        ?>
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'adresse') == true) {
                            ?>
                        ...
                        ?>
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'telephone') == true) {
                            ?>
                        ...
                        ?>
                        <?php
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'weblink') == true) {
                            ?>
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <a href="#" id="edit_img_icon_marker_link">
                                    <img class="thumb-img-admin" src="<?php echo utility::mmm_get_image_marker_src($item['img_icon_marker']); ?>" alt="">
                                </a>
                            </td>
                            <?php
                            if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'image') == true) {
                                ...
                                <td style="text-align: center">
                                    ...
                                    <a href="#" id="edit_img_desc_marker_link">
                                        <img class="thumb-img-admin" src="<?php echo utility::mmm_get_image_desc_src($item['img_desc_marker']); ?>" alt="">
                                    </a>
                                </td>
                                <?php
                            }
                            ...
                            <td class="action">
                                ...
                                <button type='submit' class='delete_marker button-secondary' name="delete_marker" id="delete_marker">
                    ...
                    <tr>
                        <td style="text-align: center">
                            ...
                            <div class="wrap-set-img">
                                <a href="#" id="add_icon_marker_link">
                                    <img class="thumb-img-admin" alt="" src="<?php echo utility::mmm_get_image_marker_src($options[0]['default_marker_img_url']) ?>">
                                </a>
                            </div>
                        </td>
                        <?php
                            ...
                            <td style="text-align: center">
                                ...
                                <div class="wrap-set-img">
                                    <a href="#" id="add_icon_desc_link">
                                        <img class="thumb-img-admin" alt="" src="<?php echo utility::mmm_get_image_desc_src($options[0]['default_desc_img_url']) ?>">
                                    </a>
                                </div>
                            </td>
                            <?php
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'titre') == true) {
                            ?>
                            <td>
                                <input maxlength="50" type="text" name="add_titre" placeholder="<?php _e('Title', MapMultiMarker::TEXT_DOMAIN) ?>">
                            </td>
                            <?php
                        }
                        ?>
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'description') == true) {
                            ?>
                            <td>
                                <textarea maxlength="255" style="width:100%" id="add_description" name="add_description" placeholder="<?php _e('Description', MapMultiMarker::TEXT_DOMAIN
                                ) ?>"></textarea>
                            </td>
                            <?php
                        }
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'adresse') == true) {
                            ?>
                            <td>
                                <textarea maxlength="255" name="add_adresse" placeholder="<?php _e('Address', MapMultiMarker::TEXT_DOMAIN) ?>"></textarea>
                            </td>
                            <?php
                        }
                        ?>
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'telephone') == true) {
                            ?>
                            <td>
                                <input maxlength="12" type="text" name="add_telephone" placeholder="<?php _e('Phone', MapMultiMarker::TEXT_DOMAIN) ?>">
                            </td>
                            <?php
                        }
                        ?>
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'weblink') == true) {
                            ?>
                            <td>
                                <input maxlength="255" type="text" name="add_weblink" placeholder="<?php _e('Web link', MapMultiMarker::TEXT_DOMAIN) ?>">
                            </td>
                            <?php
                        }
                        ?>
                        <td>
                            <input maxlength="10" type="text" name="add_latitude" class="requiered" placeholder="<?php _e('Latitude', MapMultiMarker::TEXT_DOMAIN) ?>">
                        </td>
                        <td>
                            <input maxlength="11" type="text" name="add_longitude" class="requiered" placeholder="<?php _e('Longitude', MapMultiMarker::TEXT_DOMAIN) ?>">
                        </td>
                        <td>
                            <button type='submit' class='button-primary button-success' name="create_marker" id="create_marker">
                                <i class="fa fa-plus" aria-hidden="true"></i> <?php _e('Add', MapMultiMarker::TEXT_DOMAIN); ?>
                            </button>
                        </td>
                    </tr>
                    </tfoot>
