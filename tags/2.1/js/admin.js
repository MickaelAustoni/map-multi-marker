...
(function($) {
	...
	function mapmarker_alert_msg_js(alert, msg){
		...
		**
		*/
		$("#title-manage-marker").after('<div class="notice notice-'+alert+' is-dismissible"><p><strong>'+msg+'</strong></p><button type="button" class="notice-dismiss"><span class="screen-reader-text">Ne pas tenir compte de ce message.</span></button></div>');
	}
