...
== Description ==
Easily create a google map on your wordpress with a simple shortcode and add unlimited number of markers. Many options are available to fully customize your marker and map.

* Create and diplay unlimited number of maps
