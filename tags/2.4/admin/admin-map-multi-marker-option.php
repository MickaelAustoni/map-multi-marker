					    ...
					    <div class="row">
					    	<div class="col-md-6">
							    <table class="form-table">
							        ...
							        <tr>
							            <th scope="row">
							                <label for="zoom"><?php _e('Initial zoom', 'map-multi-marker'); ?></label></th>
							            <td>
							...
							<div class="col-md-6">
							    <table class="form-table">
							        ...
							        <tr>
							            <th scope="row">
							                <label for="fiels_to_display"><?php _e('Fields to display in tooltip', 'map-multi-marker'); ?></label></th>
							            <td>
							        ...
							        <tr>
							            ...
							            <th scope="row">
							                <label for="default_marker_img"><?php _e('Default marker icon when a new marker is created', 'map-multi-marker'); ?></label></th>
							            <td>
								            <div class="wrap-set-default-img">
