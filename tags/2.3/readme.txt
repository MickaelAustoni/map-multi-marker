...
Donate link: https://www.paypal.me/MickaelAustoni
Tags: map, maps, marker, markers, map marker, google map, google map plugin, multiple marker map, multi marker google map, easy map, ajax marker, location, map multi marker, plugin map wordpress, wp plugin map
Tested up to: 4.6.1
Stable tag: 2.3
...
Easily create multiple markers on a google map !


== Description ==
Easily create a google map on your wordpress with a simple shortcode and add multiples markers. Many options are available to fully customize your marker and map.

* Create and diplay map
...
== Installation ==
1. Upload the entire `map-multi-marker` folder(unzip) to the `/wp-content/plugins/` directory.
2. Activate the plugin through the `/Plugins`/ menu in WordPress.
3. Add the shortcode [map-multi-marker] where you want display the map


= Translations =
* Get a free pro version of Map Multi Marker in exchange for translating our plugin in your language !
...
* Add the possibility to set a default markeur and image tooltip when a new markeur is created
* Minor text fixes
