...
if (isset($_POST['securite_nonce_option'])) {
	...
	if( wp_verify_nonce($_POST['securite_nonce_option'], 'securite-nonce') ) {
			...
			$streetview = (isset($_POST['streetview'])) ? 1 : 0;
	    ...
	    <div class="row">
			...
			<div class="col-md-6">
			    <table class="form-table">
			        ...
			        <tr>
			            <th scope="row">
			                <label for="scrollwheel"><?php _e('Scrollwheel zoom', 'map-multi-marker'); ?></label></th>
			            <td>
			            	<input id="scrollwheel" type="checkbox" name="scrollwheel" <?php if($data[0]['scrollwheel'] == 1){echo 'checked';} ?>>
			        </tr>
			        <tr>
			            <th scope="row">
			                <label for="streetview"><?php _e('Streetview', 'map-multi-marker'); ?></label></th>
			            <td>
			            	<input id="streetview" type="checkbox" name="streetview" <?php if($data[0]['streetview'] == 1){echo 'checked';} ?>>
			        </tr>
			        <tr>
			            <th scope="row">
