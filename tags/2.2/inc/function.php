...
function mapmarkerMarkerContent(){
    ...
    <div class="wrap-desc-markeur">
        ...
        <?php if ( mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'titre') == true AND !empty($data[0]['titre'])): ?>
            <h2><?php echo esc_html($data[0]['titre'])?></h2>
        <?php endif ?>

        <!-- Si le champ de la "description" est coché -->
        <?php if ( mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'description') == true AND !empty($data[0]['description'])): ?>
        ...
        <?php if ( mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'adresse') == true OR mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'telephone') == true OR mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'weblink') == true ): ?>
            <ul class="contact-list">
                ...
                <?php if (mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'adresse') == true AND !empty($data[0]['adresse'])): ?>
                	<li class="adresse"><strong><?php echo esc_html($data[0]['adresse'])?></strong></li>
                <?php endif ?>
                <!-- Si le champ de la "description" est coché -->
                <?php if (mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'telephone') == true AND !empty($data[0]['telephone'])): ?>
                ...
                <?php if (mapmarker_get_checked_field($get_field[0]['fiels_to_display'], 'weblink') == true AND !empty($data[0]['weblink'])): ?>
...
function mapMarker_add_action_links($links) {
	...
	$mylinks = array('<a style="font-weight:bold;color:#4CAF50;" href="'.$mapmarker_info['donate_link'].'" target="_blank">' . __( 'Donate', 'map-multi-marker' ) . '</a>',);
