...
require_once MapMultiMarker::instance()->plugin_path . 'app/controller/controller.php';
require_once MapMultiMarker::instance()->plugin_path . 'app/model/model_mapper.php';
require_once MapMultiMarker::instance()->plugin_path . 'app/utility/utility.php';
require_once MapMultiMarker::instance()->plugin_path . 'app/utility/csv_reader.php';

class controller_map_multi_marker_page_manage extends controller
{
