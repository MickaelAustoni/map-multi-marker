...
<div class="wrap">
    ...
    <?php if (empty($this->api_key) || $this->api_key === MapMultiMarker::DEFAULT_API_KEY): ?>
        <div class="error notice">
            <p><strong><?php echo __('Now, before you start using Map Multi Marker, please note that it is necessary to register your API key', MapMultiMarker::TEXT_DOMAIN) . __('to work properly.',
