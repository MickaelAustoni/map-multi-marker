                ...
                <table class="widefat" id="table_markers">
                    ...
                    foreach ($data as $item) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                ...
                                <a href="#" id="edit_img_icon_marker_link"><img class="thumb-img-admin" src="<?php echo utility::mmm_get_image_marker_src($item['img_icon_marker']); ?>" alt=""></a>
                            </td>
                            <?php
                            if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'image') == true) {
                                ?>
                                <td style="text-align: center">
                                    ...
                                    <a href="#" id="edit_img_desc_marker_link"><img class="thumb-img-admin" src="<?php echo utility::mmm_get_image_desc_src($item['img_desc_marker']); ?>" alt=""></a>
                                </td>
                                <?php
                            }
                            ?>
                    ...
                    <tr>
                        ...
                        if (utility::mmm_is_checked_field($options[0]['fiels_to_display'], 'description') == true) {
                            ?>
                            <td>
                                <textarea maxlength="255" style="width:100%" id="add_description" name="add_description" placeholder="<?php _e('Description', MapMultiMarker::TEXT_DOMAIN) ?>"></textarea>
                            </td>
                            <?php
                        }
                        ?>
