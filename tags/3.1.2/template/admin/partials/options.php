                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="fiels_to_display"
                                                   ...
                                                   value="image" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'image') ?>><?php _e('Image', MapMultiMarker::TEXT_DOMAIN); ?>
                                            <br>
                                            <input id="fiels_to_display"
                                                   type="checkbox"
                                                   name="fiels_to_display[]"
                                                   value="titre" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'titre') ?>><?php _e('Title', MapMultiMarker::TEXT_DOMAIN); ?>
                                            <br>
                                            <input id="fiels_to_display"
                                                   type="checkbox"
                                                   name="fiels_to_display[]"
                                                   value="description" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'description') ?>><?php _e('Description', MapMultiMarker::TEXT_DOMAIN); ?>
                                            <br>
                                            <input id="fiels_to_display"
                                                   type="checkbox"
                                                   name="fiels_to_display[]"
                                                   value="adresse" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'adresse') ?>><?php _e('Address', MapMultiMarker::TEXT_DOMAIN); ?>
                                            <br>
                                            <input id="fiels_to_display"
                                                   type="checkbox"
                                                   name="fiels_to_display[]"
                                                   value="telephone" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'telephone') ?>><?php _e('Phone', MapMultiMarker::TEXT_DOMAIN); ?>
                                            <br>
                                            <input id="fiels_to_display"
                                                   type="checkbox"
                                                   name="fiels_to_display[]"
                                                   value="weblink" <?php utility::mmm_e_is_checked_field($data[0]['fiels_to_display'], 'weblink') ?>><?php _e('Web link', MapMultiMarker::TEXT_DOMAIN); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
