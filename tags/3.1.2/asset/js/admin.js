...
(function ($) {
     ...
     */
    jQuery(document).on('click', '#upload_desc_img_button, #upload_marker_img_button, #edit_img_icon_marker_link.edit-active, #edit_img_desc_marker_link.edit-active, #add_icon_marker_link, #add_icon_desc_link', function (event) {
        event.preventDefault();
