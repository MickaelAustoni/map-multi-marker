...
Tags: map marker, map, maps, marker, markers, google map, easy map, google map plugin, multiple marker, multi marker google map, simple map, add map, ajax marker, location, map multi marker
...
* Optimized plugin decurity (Sanitize, escape, and validate POST calls) & using Nonces
