...
function mapmarkerDisplayMap(){
	...
	if ( shortcode_exists( $mapmarker_info['shortcode'] ) ) {
		...
		// Charge les script necessaire pour le front
		mapmarker_front_script();

		?>	
		<!-- Div pour afficher la map -->
		<div id="map" class="mapmarker" <?php mapmarker_get_options('size_map'); ?>></div>
	    ...
	    <script type="text/javascript">
			...
			function initMap() {
				...
				var mapOptions = <?php mapmarker_get_options('base_map'); ?>;
			...
			function get_Markers() {
				...
				var marker_array = <?php mapmarker_get_makers(); ?>;
