...
<div class="wrap">
	...
	<div class="wrap-help-mmm">
		<h2><?php _e('Example CSV file.', 'map-multi-marker'); ?></h2>
		<img src="<?php echo plugin_dir_url(__DIR__).'img/help-csv.jpg'; ?>" alt="Image d'aide pour le plugin" class="help-img img-responsive">
	</div>
